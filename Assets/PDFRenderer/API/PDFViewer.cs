...
#pragma warning restore 414
        ...
        internal SharePDF sharePDF;
        public int GetCurrentPageNumber(){
            return currentpagenumber;
        }

        protected override void Awake(){
            sharePDF = GetComponent<SharePDF>();
        }
        ...
        public void ZoomIn()
        {
            ...
            /*if(sharePDF.isPresenter == true){
                sharePDF.ZoomPDF(m_Internal.Viewport.rect.size.y,true);
            }*/
        }
        ...
        public void ZoomOut()
        {
            ...
            if(sharePDF.isPresenter==true){
                sharePDF.ZoomPDF(m_Internal.Viewport.rect.size.y,false);
            }
        }

        public void NetworkZoom(float x,bool zoomin){
            ZoomCommon(new Vector2(0.0f , x * 0.5f),zoomin);
        }
